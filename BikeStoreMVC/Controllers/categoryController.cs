...
namespace BikeStoreMVC.Controllers
{
    public class categoryController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "catID,category")] tbl_category tbl_category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "catID,category")] tbl_category tbl_category)
        {
            if (ModelState.IsValid)
            {
